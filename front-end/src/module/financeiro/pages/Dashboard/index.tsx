...
function Dashboard() {
            ...
            <div className="p-2">
                  ...
                  <div className="h-full text-right" >
                        <div>
                              ...
                              <div id='total-geral' className="w-full " style={{ color: theme.colors.success }}>
                                    <CountUp className="font-bold lg:text-4xl" end={205500.36} prefix='R$ ' separator="." decimal="," decimals={2} />
                              </div>
                        </div>
                  </div>
                  <hr />
                  <div className="h-full text-right" >
                        <div>
                              <p className="font-bold">Total de taxa</p>
                              <div id='total-taxa' className="w-full" style={{ color: theme.colors.warning }}>
                                    <CountUp className="font-bold lg:text-2xl" end={5500.36} prefix='+ R$ ' separator="." decimal="," decimals={2} />
                              </div>
                        </div>
                  </div>
                  <hr />
                  <div className="h-full text-right" >
                        <div>
                              <p className="font-bold">Total de desconto</p>
                              <div id='total-desconto' className="w-full" style={{ color: theme.colors.error }}>
                                    <CountUp className="font-bold lg:text-2xl" end={1100.00} prefix='- R$ ' separator="." decimal="," decimals={2} />
                              </div>
                        </div>
                  </div>
                  <hr />
                  <div className="h-full" >
                        <div>
                              ...
                              <div id='total-liquido' className="w-full text-right" style={{ color: theme.colors.info }}>
                                    <CountUp className="font-bold lg:text-4xl" end={209000.00} prefix='R$ ' separator="." decimal="," decimals={2} />
                              </div>
                        </div>
                  </div>
            </div>
      ...
      const cardFaturamentoMes = (
            <LinhaChart isLegend={true}
                  label="Faturamento Mensal Compra x Venda"
                  colorLine1={theme.colors.success}
                  colorLine2={theme.colors.error}
                  tipo1="Venda"
                  tipo2="Comprar"
                  data={[
                        { name: 'jan', value1: 30000.00, value2: 15000.60 },
                        { name: 'fev', value1: 45780.65, value2: 20000.60 },
                        { name: 'mar', value1: 15780.65, value2: 35000.60 },
                        { name: 'abr', value1: 5780.65, value2: 45000.60 },
                        { name: 'mar', value1: 12780.65, value2: 25000.60 },
                        { name: 'jun', value1: 18780.65, value2: 5000.60 },
                        { name: 'jul', value1: 19780.65, value2: 85000.60 },
                        { name: 'ago', value1: 25780.65, value2: 75000.60 },
                        { name: 'set', value1: 90780.65, value2: 95000.60 },
                        { name: 'out', value1: 10780.65, value2: 5000.60 },
                        { name: 'nov', value1: 15780.65, value2: 25000.60 },
      ...
      const cardFaturamentoAno = (
            <BarraChart
                  ...
                  colorBar1={theme.colors.success}
      ...
      return <Container>
            <div className="p-3" style={{ backgroundColor: (theme.title === 'dark' ? theme.colors.tertiary : theme.colors.white), borderRadius: '8px' }}>
                  ...
                  <div className="w-full grid grid-cols-1 gap-2 h-max lg:grid-cols-3 gap-2 lg:h-max h-96 mb-5">
                        <SummaryCustom className='mb-2 lg:mb-0 h-80 lg:col-start-1 lg:col-span-2 ' id="total-dinheiro" children={cardFaturamentoTotal} colorBorder={theme.colors.primary} />
                        <SummaryCustom className="h-80" id="total-dinheiro" children={cardPizza} colorBorder={theme.colors.primary} />
                  </div>
                  <SummaryCustom className="h-72 mb-5" id="total-dinheiro" children={cardProdutoMaisVendido} colorBorder={theme.colors.primary} />
                  <SummaryCustom className="h-72 mb-5" id="total-dinheiro" children={cardFaturamentoMes} colorBorder={theme.colors.primary} />
                  <SummaryCustom className="h-72 mb-5" id="total-dinheiro" children={cardFaturamentoAno} colorBorder={theme.colors.primary} />
