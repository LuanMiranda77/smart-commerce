...
import { ButtonIcon, Divider, InputDefault, InputMask, InputSelectDefault, ToastDefault } from "../../../../components";
...
function Estabelecimento() {
  ...
  return <Container className="p-3">
    ...
    <div id='endereco' className="mb-5">
      ...
      <div className="flex">
        <InputMask className="w-4/12 mr-5" label="Bairro" mask={'99999-999'}></InputMask>
